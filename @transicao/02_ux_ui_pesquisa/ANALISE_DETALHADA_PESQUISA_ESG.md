...
- **Princípio-chave:** *Slow reveal* — introduzir elementos de dados progressivamente, como Hans Rosling fazia em TED Talks
...
**Princípio central:** *"Nenhum gráfico é totalmente acessível — sempre forneça tabela de dados alternativa."*
...
**Citação de Cole Nussbaumer Knaflic:** *"Simples vence sofisticado — foque na mensagem, não no gráfico."*
...
- Frase em linguagem natural (*"Seu município melhorou 5 pontos desde 2024"*)
- CTA claro (*"Ver detalhes por ODS →"*)
...
- **3 segundos:** KPI cards (*"Está tudo bem?"*)
- **30 segundos:** Filtros e contexto (*"O que mudou?"*)
- **300 segundos:** Análise profunda (*"Por quê?"*)
...
- Transformar *"Seu score ODS 4 é 38"* em *"3 em cada 10 crianças do seu município concluem o ensino fundamental na idade certa. Veja o que fazer."*

**Attractive (Atrativo):**
- Números grandes e bold
- Personalização: *"Prefeito(a) [Nome], estas são suas prioridades."*
- **Framing de perda aumenta ação em ~7%:** Use *"Seu município está ficando para trás"* ao invés de *"Seu município pode melhorar"*

**Social:**
- Prova social: *"85% dos municípios do seu estado já acessaram seus planos de ação."*
...
- Framing de custo imediato: *"Agir agora em saneamento (ODS 6) pode evitar R$X em custos de saúde no próximo ano."*
...
| **Z-score** | Estatisticamente robusto | "*seu score é -0,5 desvios-padrão*" não significa nada para prefeito | Ninguém para comunicação pública |
...
- Mostrar completude como métrica separada (*"Dados disponíveis: 85/100 indicadores"*)
- Tratar lacunas como oportunidade: *"Ajude-nos a melhorar o monitoramento reportando X."*
...
**Estratégia de layering (AHRQ):** *"Exiba o score composto primeiro e não force o usuário a ver detalhes que não deseja."*
...
- Tendência: *"Muitos vencedores estão integrando IA de formas sofisticadas."*
...
- Sparkline de tendência
- Contexto/benchmark (*"Média estadual: 68,1"*)
...
- *"Se investir R$X em saneamento, seu score ODS 6 projetado sobe Y pontos."*
- Usar modelos de regressão baseados em dados históricos dos 5.570 municípios
...
**Implementação secundária (Fase 2):**
3. Recomendações 5-7 (peer-to-peer, simulador, IA)
4. Recomendações 9-10 (alertas, prêmios)
