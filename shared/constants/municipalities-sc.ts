import type { MunicipalitySeed } from "../types/domain/municipality.js";

/**
 * 295 municípios de Santa Catarina — dados do IBGE (servicodados.ibge.gov.br)
 * Gerado automaticamente em 2026-03-31
 */
export const SC_MUNICIPALITIES: readonly MunicipalitySeed[] = [
...
export const SC_MUNICIPALITY_COUNT = 295;
