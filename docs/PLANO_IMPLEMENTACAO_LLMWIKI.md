...
4.  Modificar o arquivo `CLAUDE.md` na raiz do projeto para incluir uma diretiva obrigatória: *"Ao final de cada tarefa complexa, execute o comando `/wiki-ingest` para documentar o conhecimento gerado."*
...
*Critério de Aceite da Fase 3:* A pasta `/wiki` deve conter um `index.md` rico, interligando todo o conhecimento legado de forma coesa, sem contradições aparentes, e o `log.md` deve registrar a "Grande Ingestão".
...
Siga estritamente o plano definido em `docs/PLANO_IMPLEMENTACAO_LLMWIKI.md`.
